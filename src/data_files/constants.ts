...
export const partnersData = [
  ...
  { icon: "morgen.png", name: "Morgen", href: "#" },
  { icon: "evomab.png", name: "Evomab", href: "#" },
  { icon: "concord.png", name: "Concord", href: "#" },
  { icon: "panama.png", name: "Panama", href: "#" },
  { icon: "arwana.png", name: "Arwana", href: "#" },
  { icon: "arna.png", name: "Arna", href: "#" },
  { icon: "sinarmas.png", name: "Sinarmas", href: "#" },
  { icon: "motul.png", name: "Motul", href: "#" },
  { icon: "scarlett.jpg", name: "Scarlett", href: "#" },
  { icon: "strepsil.png", name: "Strepsils", href: "#" },
  { icon: "laruso.png", name: "Laruso", href: "#" },
];